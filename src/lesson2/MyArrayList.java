...
public class MyArrayList<T extends Comparable<T>> {
    ...
    public void listExpansion() {         // expansion method (autousing)
        MyArrayList<T> newMaL = new MyArrayList<>(this.capacity*2);
        System.arraycopy(this.list,0,newMaL.list,0,this.size);
        this.list = newMaL.list;
        this.capacity = newMaL.capacity;
    }
